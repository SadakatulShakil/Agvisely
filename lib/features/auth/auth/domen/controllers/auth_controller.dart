...
class AuthController extends GetxController {
  ...
  // picker before the user ever reaches signup. Read the mirrored values
  // straight from UserPrefService (see _syncMirrorFromList).
  ...
  /// Sign-up flow: validate every field, then go to OTP. District/Upazila
  /// come from the location already resolved before this page (GPS or the
  /// manual picker) — no fields to fill in here.
  void requestOtpForSignup() {
    ...
    final req = SignupRequest(
      ...
      district: UserPrefService().locationDistrict ?? '',
      upazila: UserPrefService().locationUpazila ?? '',
